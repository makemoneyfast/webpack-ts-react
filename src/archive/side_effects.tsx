...
const Container = () => {
  ...
  const incrementClickHandler5: () => void = () => five();

  function six() {
    answer5 = answer5 - 19;
  }
  const decrementClickHandler5: () => void = () => six();
  ...
  const incrementClickHandler6: () => void = () => lolo.increment();
  const decrementClickHandler6: () => void = () => lolo.decrement();
